...
const TdsPopoverCore = /*@__PURE__*/ proxyCustomElement(class TdsPopoverCore extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["tds-popover-core"];
  components.forEach(tagName => { switch (tagName) {
    case "tds-popover-core":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, TdsPopoverCore);
      }
      break;
  } });
}

export { TdsPopoverCore as T, defineCustomElement as d };
