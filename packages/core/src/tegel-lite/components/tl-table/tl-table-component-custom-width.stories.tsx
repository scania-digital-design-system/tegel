    ...
    <div style="overflow-x: auto; width: 100%;">
      ...
      <thead class="tl-table__header">
        <tr class="tl-table__row">
          ...
          <th class="tl-table__header-cell" data-column="1" ${getColumnStyle(
            column2Width,
          )}>Driver name</th>
          <th class="tl-table__header-cell" data-column="2" ${getColumnStyle(
            column3Width,
          )}>Country</th>
          <th class="tl-table__header-cell" data-column="3" ${getColumnStyle(
            column4Width,
          )}>Mileage</th>
        </tr>
      </thead>
      <tbody class="tl-table__body">
        <tr class="tl-table__row">
          <td class="tl-table__body-cell" data-column="0" ${getColumnStyle(
            column1Width,
          )}>Test value 1</td>
          <td class="tl-table__body-cell" data-column="1" ${getColumnStyle(
            column2Width,
          )}>Test value 2</td>
          <td class="tl-table__body-cell" data-column="2" ${getColumnStyle(
            column3Width,
          )}>Test value 3</td>
          <td class="tl-table__body-cell" data-column="3" ${getColumnStyle(
            column4Width,
          )}>Test value 4</td>
        </tr>
        <tr class="tl-table__row">
