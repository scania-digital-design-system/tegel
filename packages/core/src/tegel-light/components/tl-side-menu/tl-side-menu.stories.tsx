...
export default {
  title: 'Tegel Light (CSS)/Side Menu',
  parameters: {
    layout: 'fullscreen',
    docs: {
      source: {
    ...
    <header class="tl-header">
      <nav class="tl-header__nav">
        <ul class="tl-header__list">
          ...
          <li class="tl-header__item">
            <a class="tl-header__item-wrapper"><div class="tl-header__brand-symbol"></div></a>
          </li>
        </ul>
      </nav>
    </header>
            ...
            <div class="tl-side-menu__navigation">
              ...
              <div class="tl-side-menu__list-wrapper">
                <ul class="tl-side-menu__list tl-side-menu__list--upper">
                  ...
                  <li><div class="tl-side-menu__item-wrapper"><div class="tl-side-menu__item tl-side-menu__item"><button><span class="tl-icon tl-icon--truck ${icon24}" aria-hidden="true"></span>Trucks</button></div></div></li>
