    ...
    >
      ${
        topSlot
          ? `
      <div slot="top">
        <tds-footer-group title-text="Title" tds-aria-label="Links 1">
          <tds-footer-item >
            <a href="#"> Link text</a>
          </tds-footer-item>
          <tds-footer-item >
        ...
        <tds-footer-group title-text="Title" tds-aria-label="Links 2">
          <tds-footer-item >
            <a href="#"> Link text</a>
          </tds-footer-item>
          <tds-footer-item >
        ...
        <tds-footer-group title-text="Title" tds-aria-label="Links 3">
          <tds-footer-item >
            <a href="#"> Link text</a>
          </tds-footer-item>
          <tds-footer-item >
        ...
        <tds-footer-group title-text="Title" tds-aria-label="Links 4">
          <tds-footer-item >
            <a href="#"> Link text</a>
          </tds-footer-item>
          <tds-footer-item >
      ...
      ${
        startSlot
          ? `
      <div slot="start">
        <tds-footer-group tds-aria-label="Start slot links">
          <tds-footer-item >
            <a href="#"> Link text</a>
          </tds-footer-item>
          <tds-footer-item >
      ...
      ${
        endSlot
          ? `
      <div slot="end">
        <tds-footer-group tds-aria-label="End slot links">
          <tds-footer-item >
