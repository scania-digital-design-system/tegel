    ...
    design: [
      {
        name: 'Figma',
        type: 'figma',
        url: 'https://www.figma.com/design/N3EHKGUuyqC9PmlxOF7CZQ/20260219---Tegel-UI-Library--Main-?node-id=39520-6900&m=dev',
      },
      {
        name: 'Link',
        type: 'link',
...
const Template = ({ modeVariant, selectedIndex, defaultSelectedIndex, leftPadding }) =>
  formatHtmlPreview(`
    ...
    const tabs = document.querySelector('tds-navigation-tabs');
