...
test.describe.parallel('tds-inline-tabs', () => {
  ...
  test('renders inline-tabs correctly', async ({ page }) => {
    const inlineTabs = page.locator('tds-inline-tabs');
  ...
  test('selected tab index should be 0', async ({ page }) => {
    const selectedIndex = await page.locator('tds-inline-tabs').getAttribute('selected-index');
  ...
  test('Click on Second tab selects it and updates selected-index', async ({ page }) => {
    ...
    const firstTab = page.locator('tds-inline-tab:has-text("First tab") >> div');
    const secondTab = page.locator('tds-inline-tab:has-text("Second tab is much longer") >> div');
    ...
    // const firstTab = page.locator('tds-inline-tab div');
  ...
  test('Click on Third tab selects it and updates selected-index', async ({ page }) => {
    ...
    const secondTab = page.locator('tds-inline-tab:has-text("Second tab is much longer") >> div');
    const thirdTab = page.locator('tds-inline-tab:has-text("Third tab") >> div');
