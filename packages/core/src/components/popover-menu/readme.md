...
<tds-popover-menu id="popover" selector="#trigger" open="showPopover">
  <tds-popover-menu-item>
    <a href="#">Action</a>
  </tds-popover-menu-item>
</tds-popover-menu>
...
| `show`           | `show`            | Controls whether the Popover is shown or not. If this is set hiding and showing will be decided by this prop and will need to be controlled from the outside. This also means that clicking outside of the popover won't close it. Takes precedence over `defaultOpen` prop. | `boolean`                                                                                                                                                                                                    | `null`      |
