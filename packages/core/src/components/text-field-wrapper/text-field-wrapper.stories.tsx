...
export default {
  title: `${ComponentsFolder}/Text Field Wrapper`,
  parameters: {
    notes: readme,
    layout: 'centered',
    design: [
...
const Template = ({
  ...
  const maxlength = maxLength > 0 ? `maxlength="${maxLength}"` : '';
      ...
      ${noMinWidth ? 'no-min-width' : ''} >
        ...
        ${
          prefix || suffix
            ? `
          ${
            prefixType === 'Text' || suffixType === 'Text'
  ...
  <script>
    textElement = document.querySelector('input')
