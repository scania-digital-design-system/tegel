...
| `modifiers`      | `modifiers`        | Array of modifier objects to pass to popper.js. See https://popper.js.org/docs/v2/modifiers/                                                                                                                                                                                 | `object[]`                                                                                                                                                                                                   | `[]`        |
...
| `referenceEl`    | `reference-el`     | Element that will trigger the Popover (takes priority over selector)                                                                                                                                                                                                         | `HTMLElement`                                                                                                                                                                                                | `undefined` |
