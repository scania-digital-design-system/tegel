...
| `tdsAriaLabel`   | `tds-aria-label`   | Provides an accessible name for the message component when no header is present. This ensures proper screen reader support for dialog/alertdialog roles. | `string \| undefined`                                | `undefined`     |
