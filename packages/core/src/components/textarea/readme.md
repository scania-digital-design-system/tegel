...
| `hideMaxLength`    | `hide-max-length`     | Lets user control whether to hide max length indicator of textarea                                           | `boolean`                             | `false`      |
...
| `rows`             | `rows`                | Textarea rows attribute                                                                                      | `number \| undefined`                 | `undefined`  |
