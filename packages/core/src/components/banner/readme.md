...
| `icon`      | `icon`      | Name of the icon for the component. For error and information variant, the icon is predefined.                                                                                                                                                      | `string \| undefined`                   | `undefined`          |
| `isHidden`  | `hidden`    | Hides the Banner                                                                                                                                                                                                                                    | `boolean`                               | `false`              |
