...
| `noMinWidth`            | `no-min-width`            | Enables to customize width on Table columns                                                                                                                                                                                                 | `boolean \| undefined`                                                   | `undefined`          |
| `responsive`            | `responsive`              | Enables Table to take 100% available width with equal spacing of columns                                                                                                                                                                    | `boolean`                                                                | `false`              |
| `sortColumnKey`         | `sort-column-key`         | Column key for the currently sorted column.                                                                                                                                                                                                 | `string \| undefined`                                                    | `undefined`          |
| `sortDirection`         | `sort-direction`          | Current sorting direction for the column set by sortColumnKey.                                                                                                                                                                              | `"asc" \| "desc" \| undefined`                                           | `undefined`          |
