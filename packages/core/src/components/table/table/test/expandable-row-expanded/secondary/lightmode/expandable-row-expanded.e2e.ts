...
const componentTestPath =
  'src/components/table/table/test/expandable-row-expanded/secondary/lightmode/index.html';

test.describe.parallel('tds-table-expandable-row-expanded-secondary-lightmode', () => {
