...
const componentTestPath =
  'src/components/table/table/test/expandable-row-expanded/primary/darkmode/index.html';

test.describe.parallel('tds-table-expandable-row-expanded-primary-darkmode', () => {
