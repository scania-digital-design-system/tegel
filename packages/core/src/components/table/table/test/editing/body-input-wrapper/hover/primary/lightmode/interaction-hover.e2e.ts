...
const componentTestPath =
  'src/components/table/table/test/editing/body-input-wrapper/hover/primary/lightmode/index.html';

test.describe.parallel('tds-table-editable-cells-hover-primary-lightmode', () => {
