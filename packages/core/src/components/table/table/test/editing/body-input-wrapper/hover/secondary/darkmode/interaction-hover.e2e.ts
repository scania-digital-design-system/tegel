...
const componentTestPath =
  'src/components/table/table/test/editing/body-input-wrapper/hover/secondary/darkmode/index.html';

test.describe.parallel('tds-table-editable-cells-hover-secondary-darkmode', () => {
