...
export default {
  ...
  argTypes: {
    ...
    expandRow: {
      name: 'Expand row',
      description: 'Expands row by default. For demo purpose expand first row.',
      control: {
        type: 'boolean',
      },
      table: {
...
const ExpandableRowTemplate = ({
  ...
  <tds-table
    ...
    >
      ...
      <tds-table-body>
        <tds-table-body-row-expandable isExpanded=${expandRow} class="${
    expandRow && 'tds-table__row-expand--active'
  }">
