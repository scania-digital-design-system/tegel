...
export default {
  ...
  argTypes: {
    ...
    zebraMode: {
      name: 'Zebra mode',
      description: 'Enables zebra mode for the table.',
      control: {
        type: 'radio',
      },
      options: ['rows-odd', 'rows-even', 'columns-odd', 'columns-even', 'none'],
    },
    noMinWidth: {
...
const ZebraModeTemplate = ({
  ...
  <tds-table
      ...
      ${zebraMode !== 'none' ? `zebra-mode="${zebraMode}"` : ''}
