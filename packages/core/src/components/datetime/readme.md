...
| `labelPosition` | `label-position` | Position of the label                                                                                                                                                     | `"inside" \| "no-label" \| "outside"`                       | `'outside'`                        |
...
| `tdsAriaLabel`  | `tds-aria-label` | Value for the aria-label attribute                                                                                                                                        | `string`                                                    | `undefined`                        |
