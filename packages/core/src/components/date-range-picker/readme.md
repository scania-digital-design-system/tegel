...
| `endDate`       | `end-date`        | The selected end date for the Date Range Picker                                                                                                                                                   | `string`                              | `undefined`                           |
| `helper`        | `helper`          | Helper text for the Date Range Picker                                                                                                                                                             | `string`                              | `undefined`                           |
...
| `startDate`     | `start-date`      | The selected start date for the Date Range Picker                                                                                                                                                 | `string`                              | `format(startOfToday(), this.format)` |
