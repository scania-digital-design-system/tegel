...
| `readOnly`      | `read-only`      | Set input in readonly state. Hides the suffix slot if true. When readOnly is set to true, please include a short message informing about that in the tdsAriaLabel prop. | `boolean`                             | `false`      |
| `size`          | `size`           | Size of the input                                                                                                                                                       | `"lg" \| "md" \| "sm"`                | `'lg'`       |
| `state`         | `state`          | Error state of input                                                                                                                                                    | `"default" \| "error" \| "success"`   | `'default'`  |
| `tdsAriaLabel`  | `tds-aria-label` | Value to be used for the aria-label attribute. When readOnly is set to true, please include a short message informing about that in the tdsAriaLabel prop.              | `string`                              | `undefined`  |
