...
| `hideMaxLength`    | `hide-max-length`     | Lets user control whether to hide max length indicator of input                                              | `boolean \| undefined`                                 | `false`      |
...
| `max`              | `max`                 | Max allowed value for input type number                                                                      | `number \| string \| undefined`                        | `undefined`  |
| `maxLength`        | `max-length`          | Max length of input                                                                                          | `number \| undefined`                                  | `undefined`  |
| `min`              | `min`                 | Min allowed value for input type number                                                                      | `number \| string \| undefined`                        | `undefined`  |
...
| `step`             | `step`                | Step value for input type number                                                                             | `number \| string \| undefined`                        | `undefined`  |
| `tdsAriaLabel`     | `tds-aria-label`      | Value to be used for the aria-label attribute. Can be used for announcing that readOnly prop is set to true. | `string \| undefined`                                  | `undefined`  |
