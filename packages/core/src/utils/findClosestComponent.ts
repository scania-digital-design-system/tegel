import { getPrefixedTagNames, PrefixedTagNames } from './tagName';
...
export const findClosestComponent = (
  host: HTMLElement,
  component: keyof PrefixedTagNames,
): HTMLElement | null => host.closest(getPrefixedTagNames(host)[component]);
