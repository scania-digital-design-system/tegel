...
| `indeterminate` | `indeterminate` | Sets the Checkbox in a indeterminate state                                | `boolean` | `false`               |
...
| `sddsChange` | Sends unique Checkbox identifier and checked status when it is checked/unchecked. | `CustomEvent<{ checkboxId: string; checked: boolean; indeterminate: boolean; value?: string; }>` |
| `sddsFocus`  | Focus event for the Checkbox                                                      | `CustomEvent<FocusEvent>`                                                                        |


## Methods

### `toggleCheckbox() => Promise<{ indeterminate: boolean; checkboxId: string; checked: boolean; }>`

Toggles the checked value of the component.

#### Returns

Type: `Promise<{ indeterminate: boolean; checkboxId: string; checked: boolean; }>`
