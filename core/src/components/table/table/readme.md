...
| `enableExpandableRows` | `enable-expandable-rows` | Enables extended row feature of table                                                                                                                                                                                                      | `boolean`                  | `false`               |
| `enableMultiselect`    | `enable-multiselect`     | Enables multiselect feature of table                                                                                                                                                                                                       | `boolean`                  | `false`               |
...
| `noMinWidth`           | `no-min-width`           | Enables to customise width on table columns                                                                                                                                                                                                | `boolean`                  | `undefined`           |
