...
You can read more about naming in our code conventions right [here](https://github.com/scania-digital-design-system/tegel/blob/main/.github/CODE_STYLE.md)
...
// New ✅
<tds-dropdown mode-variant="primary">
    // ...
</tds-dropdown>
```
