...
export const TegelDesignSystem = {
  render: () => `
            ...
            <div class="tds-u-p2">
                ...
                <p class="tds-body-01">The design system supports the design and development of digital solutions at Scania. The purpose is to secure a
                ...
                <h2 class="tds-u-m1">@scania/tegel 🧱</h2>
