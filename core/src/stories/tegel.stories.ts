...
export const TegelDesignSystem = {
  render: () => `<style>
                    ...
                    <section>
                        <h1 class="tds-headline-02 test">Tegel Design System</h1>
                        <p class="tds-paragraph-01 test">The design system supports the design and development of digital solutions at
