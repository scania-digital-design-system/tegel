...
This file provides the list of icons used by `tl-icon.scss`. At build time, a loop goes through this list to automatically generate the CSS class for each icon (like `.tl-icon--heart`).

The file is generated by the `scripts/icon-token-generation.mts` script.
